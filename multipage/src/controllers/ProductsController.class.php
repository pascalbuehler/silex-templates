...
class ProductsController extends AbstractController {
    ...
    public function productdetail($id) {
        $this->addData('title', $this->products[$id]['name']);
        $this->addData('product', $this->products[$id]);
